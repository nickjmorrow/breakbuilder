...
const Box = styled('div')<{ index: number; numBoxes: number; theme: Theme; maxDates: number; seasonInfo: SeasonInfo }>`
	border: 2px solid white;
	padding-left: -10px;
	${p => getBorderCss(p.index, p.numBoxes)}
	${p => getBorderRadiusCss(p.index, p.numBoxes, p.theme.border.borderRadius.br2)}
